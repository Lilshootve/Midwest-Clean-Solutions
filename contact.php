...
<section class="py-16 md:py-24 relative overflow-hidden">
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16">
      ...
      <div class="group surface premium-card text-center p-6 lg:p-8 hover:scale-105 transition-transform">
        <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-[#E4405F] to-[#F56040] rounded-full flex items-center justify-center">
        ...
        <h3 class="font-bold text-lg text-[var(--ink)] mb-3">Instagram</h3>
        <a href="<?php echo htmlspecialchars($config['instagram']); ?>" target="_blank" rel="noopener noreferrer" class="text-[var(--blue)] hover:text-[#E4405F] font-semibold transition-colors">
          @midwestcleansol
        </a>
      </div>
      <?php endif; ?>
