...
<header id="header" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-transparent">
  <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16 md:h-20">
      <a href="/" class="text-2xl md:text-3xl font-bold text-[var(--ink)] hover:text-[var(--blue)] transition-colors">
        <?php echo htmlspecialchars($config['name']); ?>
      </a>
      
      <div class="hidden md:flex items-center space-x-1">
        <a href="/" class="px-4 py-2 text-sm font-medium <?php echo $currentPage === 'index' ? 'text-[var(--blue)]' : 'text-[var(--ink)] hover:text-[var(--blue)]'; ?> transition-colors">Home</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden pb-4">
      <div class="flex flex-col space-y-2 pt-4">
        <a href="/" class="px-4 py-2 text-base font-medium <?php echo $currentPage === 'index' ? 'text-[var(--blue)]' : 'text-[var(--ink)]'; ?>">Home</a>
